## DNB Hugo Blocks by David's Neighbour
...
- [Bootstrap 5](https://github.com/dnb-org/blocks/tree/main/bootstrap5)

This is work in progress. Subscribe to [releases](https://github.com/dnb-org/blocks/releases) to receive notifications about changes.
...
| [components](https://github.com/dnb-org/components) | Components are preconfigured features like automatic search index creation, sitemap and robots.txt creation, SEO tools, etc. |
